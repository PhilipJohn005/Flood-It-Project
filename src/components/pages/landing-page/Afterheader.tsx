  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="text-center space-y-4">
        <div className="bg-gradient-to-r from-slate to-blue-200 text-white rounded-lg p-8 shadow-xl">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <div className="bg-white/20 px-3 py-1 rounded-full text-black border-black border-2">
              Strategic Thinking
            </div>
